...
- A **Dockerfile template** -- used during `sandcastle init` when you choose sandboxed execution

## Built-in Providers

### Claude Code

The default agent provider. Uses Claude Code as the AI coding agent in Sandcastle-managed execution.
